...
while game_is_on:
    time.sleep(0.06)  #==> make the ball moves slower: pause the loop for a short time during each iteration. ==> get our while loop to sleep for a little bit in between each of the updates. ==> Also, I can think of it as getting the ball to move on every refresh of the screen.
